...
asadsad[] = Extrude {0, 0, 1/2*Thickness_implant} { Surface{179}; } ;
Extrude {0,0,1/2*Thickness_implant} { Surface{187} ;}
Extrude {0,0,1/2*Thickness_implant} {Surface{188};}
Extrude {0,0,1/2*Thickness_implant} {Surface{189};}
Extrude {0,0,1/2*Thickness_implant} {Surface{190};}
Physical Volume("The volume3333", 143543543) = {asadsad[1]};
