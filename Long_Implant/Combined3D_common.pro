...
Width_tissue = mm * DefineNumber[ 15, Name "Geometry/3Width tissue (mm)" ];
Thickness_tissue = mm * DefineNumber[ 15, Name "Geometry/4Thickness tissue (mm)" ];
Length_tissue = mm * DefineNumber[ 20, Name "Geometry/5Length tissue (mm)" ];
S_tissue = DefineNumber[ 2, Name "Geometry/6S tissue" ];

//GEOMETRY IMPLANT
Width_implant = um * DefineNumber[ 60, Name "Geometry/7Width implant (um)" ];
Thickness_implant = mm * DefineNumber[ 9, Name "Geometry/8Length implant (mm)" ];
...
Depth_implant = mm * DefineNumber[ 7, Name "Geometry/11Depth implant (mm)" ];
